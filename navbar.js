        ...
        if (!document.getElementById('dynamic-navbar-styles')) {
            document.head.insertAdjacentHTML('beforeend', `
                <style id="dynamic-navbar-styles">
                    ...
                    [data-theme="light"] {
                        --bg-main: #f1f5f9; --bg-panel: #ffffff; --bg-card: #f8fafc; --bg-inner: #f1f5f9; --bg-input: #ffffff; --bg-header: #ffffff; --bg-nav: #f8fafc;    
                        ...
                        --unowned-bg: #e2e8f0; --unowned-border: #cbd5e1; --unowned-text: #64748b;
                        --nav-text: #475569; --nav-hover: #0f172a; --nav-active-bg: #ffffff; --nav-active-text: #d97706;
