...
// 🚨 무장 42종 도감 데이터 무손실 배열 압축 (속성 키 반복 제거)
const rawHeroDogam = [
    ...
    // [추가됨] 신무장 육손SP (기병/창병) 데이터 반영 완료
    ['h_yukson_sp','육손SP','wu','패시브 (100%)','후열','화공이릉','전투 시작 시 철갑 2중첩 획득. 추격 전법 발동 시 가하는 피해 10%, 공심 4% 증가(턴 종료까지). 적 2명에게 화상 1턴 우선 부여 후 자신 디버프 1개 제거(최대 2회). 행동 종료 시 적 2명에게 110% 모략 피해(추격 발동마다 55% 증가, 최대 4회).',504,755,678,423,'기병/창병','SC','천리추격','체천행도'],
...
// 🚨 장비 세팅 33종 데이터 무손실 배열 압축 (중첩 프로퍼티 제거)
const rawEqOverrides = [
    ...
    // [추가됨] 육손SP 전용 추격/모략 극대화 세팅 (장신구 '포위' 특기 적용)
    ["육손SP","진현관|강공, 기습 상승|기병 피해 가함|기책","명재복|모략 피해 가함|기병 피해 감소|치밀","박산로|기습|기병 배반, 공심 상승|포위"]
];
