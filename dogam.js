// [시스템 분석] dogam.js - 전서버 랭커 실전 1~10위 추천 전법 동기화 및 100% 무손실 엔진 (황보숭 병종 궁병/창병 픽스 완료)
...
const heroDogamData = [
    ...
    { id: 'h_heojeo', name: '허저', group: 'wei', role: '능동 (60%)', location: '전열', skill: '호치', skillDesc: '적군 2명의 통솔을 7% 탈취하고 200% 무용 피해를 입힙니다(전열 피해 40% 증가). 입힌 피해 20% 병력 회복. 확률적 쟁패 획득 및 피곤 부여.', stats: { martial: 680, tactical: 409, command: 642, speed: 550 }, unit: '창병/궁병', eq: 'TC', tacs: ["부동여산", "동장철벽"] },
