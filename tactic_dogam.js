// 삼국지 전략판 실제 전법 데이터 베이스 (안영찰채 포함 총 72종 가나다순 재정렬 본)
const tacticDogamData = [
    ...
    { id: 't_anyoung', name: '안영찰채', type: '지휘 (100%)', target: '적군 2팀, 아군 전체', desc: '매 턴 시작 시 70% 확률로 아군 전체의 병력을 회복시키고(치료율 80%, 모략의 영향 받음), 아군 전체가 행동하기 전 받는 피해를 20% 감소시킵니다(대상의 모략이 무용보다 높을 경우 계수 30% 상승). 이후 30% 확률(모략의 영향 받음)로 적군 전열에 피곤을(를) 부여합니다(턴 종료 시까지 지속).' }, // 신규 추가
