// 삼국지 전략판 실제 전법 데이터 베이스 (화소적벽 포함 총 71종 가나다순 재정렬 본)
const tacticDogamData = [
    ...
    { id: 't_hwaso', name: '화소적벽', type: '능동 (50%)', target: '적군 전체', desc: '적 전체에게 화상효과를 부여(행동 시작 시 35% 추가 모략 피해를 받음)하고 2턴 지속하며 102% 모략 피해를 가합니다.' }, // 신규 추가
...
function renderTacticDogam() {
    ...
    tacticDogamData.forEach(data => {
        ...
        card.style.borderTop = '6px solid #7b2cb0';
