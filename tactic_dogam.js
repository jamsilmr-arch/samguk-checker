// [시스템 분석] tactic_dogam.js - 전법 도감 테마 동기화 및 100% 무손실 엔진 (신전법 '격안관화' 정규화 완료)
console.log("[시스템 분석] tactic_dogam.js 고속 해시 맵 렌더러 기동 (계승 전법 80종 클린 렌더링)");
...
var tacticDogamData = [
    ...
    { id: 't_gyeokan', name: '격안관화', type: '지휘 (100%)', target: '아군 전체', desc: '매 턴 시작 시 65%의 확률로 아군 전체의 병력을 회복(치료율 40%, 모략의 영향 받음)하고 받는 피해를 20% 감소(모략의 영향 받음)시키며, 아군 후열 대상 1명의 연격률을 40% 상승(모략의 영향 받음)시킵니다. 해당 효과는 턴 종료 시까지 지속됩니다.' }, // 🚨 신전법 데이터
