// [시스템 분석] tactic_dogam.js - 전법 도감 테마 동기화 및 100% 무손실 엔진 (오염 데이터 삭제 및 78종 정규화 완료)
console.log("[시스템 분석] tactic_dogam.js 고속 해시 맵 렌더러 기동 (계승 전법 78종 클린 렌더링)");

var cStr = s => s?.toString().trim().replace(/\s+/g, '') || "";

// 🚨 [데이터 교정] 장수 고유 전법(애자필보, 축호과간, 호치) 영구 삭제 및 '유비무환' 정규 추가 (총 78종)
var tacticDogamData = [
