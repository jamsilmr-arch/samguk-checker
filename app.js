...
var heroList = [
    ...
    ...[['h_daegyo','대교'],['h_nosuk','노숙'],['h_sogyo','소교'],['h_songyeon','손견'],['h_songwon','손권'],['h_sonsanghyang','손상향'],['h_sonchaek','손책'],['h_songwon_sp','손권(제왕)'],['h_yeomong','여몽'],['h_yukson','육손'],['h_yukhang','육항'],['h_juyu','주유'],['h_jutae','주태'],['h_jeongbo','정보'],['h_hwanggae','황개'],['h_yukson_sp','육손(SP)']].map(h => ({id:h[0], name:h[1], group:'wu'})),
