...
// 전법 프로필 데이터 베이스 정형화 (65개 가나다순 완료)
const tacticList = [
    ...
    { id: 't_unseong', name: '원성재도', group: 'tactic', isOwned: false },
...
function renderButtons() {
    ...
    heroList.forEach(hero => {
        ...
        if (!targetContainer) return; // 돔 로드 실패 시 인터럽트 방지
