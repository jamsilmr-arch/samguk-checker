...
var systemGuideInsights = {
    "rank0_gun_jangbo": "💡 [전서버 1위 원본] 장보의 장벽과 장녕/좌자의 압도적 힐링을 섞어 절대 뚫리지 않는 좀비 궁병진을 형성합니다.",
    "rank0_gun_hwang": "💡 [전서버 1위 원본] 황보숭의 강직불아 피감과 유비무환을 결합하여 현재 메타 유지력의 정점을 보여줍니다.",
    "rank0_wei_sima_gu": "💡 [전서버 1위 원본] 유비무환과 안영찰채로 가후/조조가 완벽히 버티는 사이 사마의가 후적박발로 적을 지워버리는 방패덱.",
    "rank0_wei_sima_gi": "💡 [전서버 1위 원본] 조조(제왕)의 기형진 피감 버프를 바탕으로 가후가 CC를 걸고 사마의가 반객위주 서브딜을 챙기는 구성.",
    "rank0_shu_macho_an": "💡 [전서버 1위 원본] 서서의 유비무환 힐링 보좌 아래, 마초와 위연이 전열에서 적을 무자비하게 분쇄하는 안행 창병.",
    "rank0_shu_macho_chu": "💡 [전서버 1위 원본] 유비(제왕)의 유좌유용 유지력을 바탕으로 마초와 위연이 확산 타격을 우겨넣는 밸런스형 추형 창병.",
    "rank0_wei_jangryo": "💡 [전서버 1위 원본] 조조(제왕)의 군령여산 버프를 받은 장료가 호도진의 선공권을 살려 적 주장을 암살하는 속전속결 덱."
};
