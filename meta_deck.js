// [시스템 분석] meta_deck.js - 전서버 실전 메타 덱 데이터베이스 (마초 구행진 픽스 및 후열 스마트 포지셔닝 동기화 완료)
console.log("[시스템 분석] meta_deck.js 메타 덱 데이터 허브 기동");

const analyzedMetaArchetypes = [
    // 🏆 [전서버 1위/2위 생태계] 최우선순위 가중치 락인 (절대 우위)
    ...
    // 🚨 [핵심 교정] 마초 덱 진형 구행진 변경 및 순서(위연-마초-서서) 변경으로 마초 후열 강제 배치
    {id:"rank2_3", priority: 1, name:"[2위 3군] 위연·마초·서서 구행창병", concept:"[2위 3군]", formation:"구행진", officers:[{name:"위연", chosenTactics:["실병제위","간담상조","진퇴유도"]}, {name:"마초", chosenTactics:["출수법","용맹무쌍","반객위주"]}, {name:"서서", chosenTactics:["절절학문","문치무공","혼수모어"]}]},

    // 💠 [메타 세트 A]
    {id:"set_a_1", priority: 0, name:"[메타 세트 A] 위연·마초·서서 구행창병", concept:"[세트 A]", formation:"구행진", officers:[{name:"위연", chosenTactics:["실병제위","홍수첨향","이퇴위진"]}, {name:"마초", chosenTactics:["출수법","용맹무쌍","질풍노도"]}, {name:"서서", chosenTactics:["절절학문","문치무공","전위위안"]}]},
    ...
    {id:"set_b_2", priority: 0, name:"[메타 세트 B] 위연·마초·유비 구행창병", concept:"[세트 B]", formation:"구행진", officers:[{name:"위연", chosenTactics:["실병제위","토적격문","문치무공"]}, {name:"마초", chosenTactics:["출수법","용맹무쌍","질풍노도"]}, {name:"유비", chosenTactics:["인정","혼수모어","강유겸제"]}]},
    ...
    // 💠 [메타 세트 E]
    {id:"set_e_1", priority: 0, name:"[메타 세트 E] 위연·마초·서서 구행창병", concept:"[세트 E]", formation:"구행진", officers:[{name:"위연", chosenTactics:["실병제위","강유겸제","진퇴유도"]}, {name:"마초", chosenTactics:["출수법","용맹무쌍","반객위주"]}, {name:"서서", chosenTactics:["절절학문","문치무공","전위위안"]}]},
    ...
    {id:"set_f_2", priority: 0, name:"[메타 세트 F] 위연·마초·유비(제왕) 구행창병", concept:"[세트 F]", formation:"구행진", officers:[{name:"위연", chosenTactics:["실병제위","횡징폭렴","강유겸제"]}, {name:"마초", chosenTactics:["출수법","용맹무쌍","반객위주"]}, {name:"유비(제왕)", chosenTactics:["재주복주","기문둔갑","진퇴유도"]}]},
...
const systemGuideInsights = {
    ...
    "rank2_3":"💡 [2위 3군] 구행진의 후열 12% 피증 버프를 받은 마초가 폭발적인 딜을 쏟아내는 압도적 화력의 창병 덱.",
    "set_a_1":"💡 [세트 A] 구행진 중앙에 배치된 마초가 위연과 서서의 서포트를 받으며 적진을 갈아버리는 확산 피해 창병.",
    ...
    "set_b_2":"💡 [세트 B] 유비의 혼수모어/강유겸제 완벽 힐망 속에서 구행진 마초가 날뛰는 파괴적 창병.",
    ...
    "set_e_1":"💡 [세트 E] 구행진의 후방 딜 버프를 온전히 흡수한 마초가 반객위주 서브딜까지 챙긴 완전체 창병.",
    ...
    "set_f_2":"💡 [세트 F] 유비(제왕)의 완벽한 뎀감망 위에서 구행진 마초가 미쳐 날뛰는 창병.",
    "set_f_3":"💡 [세트 F] 화겁생기와 천의난위의 시너지를 극대화한 좌자/장녕/우길 구행 궁병.",
    "set_g_1":"💡 [세트 G] 서서의 절절학문/문치무공 유틸을 바탕으로 구행진 마초가 적진을 휩쓰는 창병.",
