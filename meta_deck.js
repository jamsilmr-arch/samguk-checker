// [시스템 분석] meta_deck.js - 전서버 실전 메타 덱 데이터베이스 (사마의 후적박발+반객위주 패시브 종결 메타 전면 픽스 완료)
...
const analyzedMetaArchetypes = [
    ...
    // 🚨 사마의 패시브 종결 전면 개편 (후적박발 + 반객위주)
    {id:"rank2_2", priority: 1, name:"[2위 2군] 사마의·조조·가후 추형방패", concept:"[2위 2군]", formation:"추형진", officers:[{name:"사마의", chosenTactics:["응시낭고","후적박발","반객위주"]}, {name:"조조", chosenTactics:["효웅","이퇴위진","간담상조"]}, {name:"가후", chosenTactics:["경달권변","만천과해","혼수모어"]}]},
    ...
    {id:"set_a_3", priority: 0, name:"[메타 세트 A] 사마의·조조·가후 추형방패", concept:"[세트 A]", formation:"추형진", officers:[{name:"사마의", chosenTactics:["응시낭고","후적박발","반객위주"]}, {name:"조조", chosenTactics:["효웅","안영찰채","간담상조"]}, {name:"가후", chosenTactics:["경달권변","혼수모어","만천과해"]}]},
    ...
    {id:"set_b_3", priority: 0, name:"[메타 세트 B] 조조·사마의·하후돈 구행방패", concept:"[세트 B]", formation:"구행진", officers:[{name:"조조", chosenTactics:["효웅","진퇴유도","유좌유용"]}, {name:"사마의", chosenTactics:["응시낭고","후적박발","반객위주"]}, {name:"하후돈", chosenTactics:["발시담정","홍수첨향","간담상조"]}]},
    ...
    {id:"set_c_2", priority: 0, name:"[메타 세트 C] 사마의·조조·가후 안행방패", concept:"[세트 C]", formation:"안행진", officers:[{name:"사마의", chosenTactics:["응시낭고","후적박발","반객위주"]}, {name:"조조", chosenTactics:["효웅","횡징폭렴","혼수모어"]}, {name:"가후", chosenTactics:["경달권변","만천과해","안영찰채"]}]},
    ...
    {id:"set_d_2", priority: 0, name:"[메타 세트 D] 사마의·조조·가후 추형방패", concept:"[세트 D]", formation:"추형진", officers:[{name:"사마의", chosenTactics:["응시낭고","후적박발","반객위주"]}, {name:"조조", chosenTactics:["효웅","홍수첨향","간담상조"]}, {name:"가후", chosenTactics:["경달권변","혼수모어","만천과해"]}]},
    ...
    {id:"set_e_3", priority: 0, name:"[메타 세트 E] 조조·사마의·가후 구행방패", concept:"[세트 E]", formation:"구행진", officers:[{name:"조조", chosenTactics:["효웅","간담상조","안영찰채"]}, {name:"사마의", chosenTactics:["응시낭고","후적박발","반객위주"]}, {name:"가후", chosenTactics:["경달권변","혼수모어","금창신"]}]},
    ...
    {id:"set_h_1", priority: 0, name:"[메타 세트 H] 조조·사마의·가후 구행방패", concept:"[세트 H]", formation:"구행진", officers:[{name:"조조", chosenTactics:["효웅","횡징폭렴","진퇴유도"]}, {name:"사마의", chosenTactics:["응시낭고","후적박발","반객위주"]}, {name:"가후", chosenTactics:["경달권변","혼수모어","안영찰채"]}]},
    ...
    {id:"set_i_2", priority: 0, name:"[메타 세트 I] 사마의·조조·가후 안행방패", concept:"[세트 I]", formation:"안행진", officers:[{name:"사마의", chosenTactics:["응시낭고","후적박발","반객위주"]}, {name:"조조", chosenTactics:["효웅","강유겸제","여자동포"]}, {name:"가후", chosenTactics:["경달권변","만천과해","혼수모어"]}]},
...
const systemGuideInsights = {
    ...
    // 🚨 사마의 패시브 락인 인사이트 수정
    "rank2_2":"💡 [2위 2군] 적의 CC기를 완벽히 무시하는 '후적박발+반객위주' 패시브 쌍발 엔진으로 사마의가 확정 폭딜을 넣는 추형 방패병.",
    ...
    // 🚨 사마의 패시브 락인 인사이트 수정
    "set_a_3":"💡 [세트 A] 후적박발과 반객위주를 통해 CC면역 모략 딜을 한 방에 폭발시키는 추형 방패병.",
    
    "set_b_1":"💡 [세트 B] 원소의 통솔 버프와 동탁의 피감 속에서 여포가 적의 핵심을 분쇄하는 방원 기병.",
    "set_b_2":"💡 [세트 B] 유비의 혼수모어/강유겸제 완벽 힐망 속에서 마초와 위연이 날뛰는 안행 창병.",
    
    // 🚨 사마의 패시브 락인 인사이트 수정
    "set_b_3":"💡 [세트 B] 유좌유용과 반객위주, 후적박발을 통해 딜 누수를 방지하고 사마의의 지속 화력을 극대화한 구행 방패병.",
    
    "set_c_1":"💡 [세트 C] 조조(제왕)의 완벽한 뎀감망 위에서 장료와 악진이 첫 턴 선제 폭격을 가하는 기형 창병.",
    
    // 🚨 사마의 패시브 락인 인사이트 수정
    "set_c_2":"💡 [세트 C] 횡징폭렴과 혼수모어, 만천과해의 3중 제어기로 적을 봉쇄하며 사마의가 패시브로 패는 안행 방패병.",
    ...
    // 🚨 사마의 패시브 락인 인사이트 수정
    "set_d_2":"💡 [세트 D] 홍수첨향 힐을 받은 조조가 버티는 사이 사마의가 후적/반객 쌍발로 적을 궤멸시키는 방패병.",
    ...
    // 🚨 사마의 패시브 락인 인사이트 수정
    "set_e_3":"💡 [세트 E] 후적박발 패시브 펌핑 사마의의 폭발력을 조조/가후가 뒷받침하는 구행 방패병.",
    ...
    // 🚨 사마의 패시브 락인 인사이트 수정
    "set_h_1":"💡 [세트 H] 진퇴유도와 횡징폭렴으로 공방을 잡고 사마의가 패시브로 폭발하는 구행 방패병.",
    
    "set_h_2":"💡 [세트 H] 좌자와 우길이 전선을 유지하고 장녕이 폭격하는 구행 궁병.",
    "set_i_1":"💡 [세트 I] 토적격문과 안영찰채로 버티며 장녕의 딜을 극대화한 구행 궁병.",
    
    // 🚨 사마의 패시브 락인 인사이트 수정
    "set_i_2":"💡 [세트 I] 조조의 강유겸제와 사마의 쌍패시브(후적/반객)가 빛나는 안행 방패병.",
