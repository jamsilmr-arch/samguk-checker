console.log("[시스템 분석] deck_core.js 독자적 종결 덱 AI 연산 엔진 기동 (랭커 데이터 제거 버전)");
...
const cavSet = new Set(["마초", "장료", "하후돈", "하후연", "여포", "서서", "곽가", "정욱", "가후", "손상향", "원소", "악진"]);
...
function calculateStrictDeckScore(deck) {
    ...
    // 예외: 인연 시너지가 있거나 여포 같은 극단적 코어가 있다면 밸런스 페널티 완화
