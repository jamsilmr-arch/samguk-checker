...
// [신규 주입] 장수 진영(국가) 정밀 매핑 테이블 (대체 추천 시너지 계산용)
...
const internalTacticStatMap = {
    ...
    "진퇴유도": { damageTakenRed: 4, damageDealtInc: 4 }, "사생취의": { damageDealtInc: 8, physicalDmg: 4 }, 
    ...
    "제곤부위": { healGiven: 6 }, "이아환아": { physicalDmg: 6 }, "만전제발": { physicalDmg: 6 },
