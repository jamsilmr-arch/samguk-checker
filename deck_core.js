...
// 55명 전체 무장 내장 장비 미러링 마스터 사전 (도감 통신 실패 시에도 100% 정상 작동 보장)
const FB_EQUIP_MAP = {
...
// 일반 70개 + 고유 55개 = 총 125개 전법 100% 수치 명세 내장 딕셔너리
...
const analyzedMetaArchetypes = [
    {id:"wei_sima_sp_jojo",name:"[위나라] 사마의·제왕조조 종결 방패 덱",concept:"[종결] 사마의·가후 혼란 방패",formation:"안행진",officers:[{name:"사마의",chosenTactics:["응시낭고","수상개화","요사여신"]},{name:"조조(제왕)",chosenTactics:["군령여산","이퇴위진","진퇴유도"]},{name:"가후",chosenTactics:["경달권변","안영찰채","혼수모어"]}]},
...
const systemGuideInsights = {"wei_sima_sp_jojo":"💡 [종결 메타] 제왕조조의 피해 증폭과 가후의 혼란 CC로 5턴 이후 사마의 왕귀를 완성하는 종결 방패 덱.","wei_assassin_sp":"💡 [공식 메타] 장료 정밀 타격 및 적 주장 저격.","shu_dowon_spear":"💡 [공식 메타] 유비/장비/관우 인연 및 방어 시너지.","shu_hwangchung_shield":"💡 [공식 메타] 조운/유비의 단단한 방어선 뒤 황충 폭딜.","shu_gangyu_bangwon_2":"💡 [공식 메타] 방원진 강유 스탯 강탈 + 제갈량 저항 부여.","shu_gangyu_cav":"💡 [공식 메타] 일반 유비 인정 힐량으로 기병 내구도 보강.","shu_macho_spear_2":"💡 [공식 메타] 안행진 후열 마초 폭딜 및 어그로 제어 연계.","shu_xushu_spear":"💡 [공식 메타] 서서 절절학문 버프 트리거 및 마초 파갑 돌파.","wu_magic_bow":"💡 [공식 메타] 손권/주유/노숙 모략 신기루 연계.","qun_cavalry":"💡 [종결 메타] 여포 일기토 연타 1턴 분쇄 기병.","qun_whitehorse_bow":"💡 [종결 메타] 공손찬 위진새북 기반 액티브 난사 궁병."};
...
function getOfficerEquipment(officerName, deckUnitType = "") {
    ...
    if (!rawEq) {
        rawEq = FB_EQUIP_MAP[cleanName] || FB_EQUIP_MAP[officerName] || null;
    }
