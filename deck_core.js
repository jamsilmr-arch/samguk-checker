// [시스템 분석] deck_core.js - 초경량 크로스 브릿지 엔진 (신전법 '포전인옥', '불노자위' 데이터 정규화 및 AI 알고리즘 연동)
