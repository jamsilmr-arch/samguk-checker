// [시스템 분석] deck_core.js - 1~10위 랭커 메타 + 계층적 전법 배타성 + 초경량 종결 엔진
console.log("[시스템 분석] deck_core.js 1~10위 메타 및 계층적 전법 배타성 초경량 엔진 기동");

const cStr = s => s?.toString().trim().replace(/\s+/g, '') || "";

// ==========================================================================
// LAYER 1: 초경량 자가 치유(Self-Healing) 통합 마스터 사전
// [이름, 고유전법, 적성병종, 진영, 장비아키타입(PC:물리, PCm:연격, SC:책략, TC:탱커, SH:힐러, SS:보조)]
// ==========================================================================
const FB_OFF_META = {
...
// [경량화] 하위 호환성 100% 보장 장비 사전 프록시 생성기
...
const tacticAlternativesMap = {
    ...
    "동장철벽":["간담상조","견불가최","천시지리","동구적개"], "전위위안":["간담상조","태청단경","현호제세","제곤부위","안영찰채"],
    "이퇴위진":["미우주무","천시지리","진퇴유도","홍수첨향"], "용맹무쌍":["만부막적","비사주석","질풍노도","반객위주"],
    "질풍노도":["암전난방","교취호탈","반객위주","용맹무쌍","승승장구"], "문치무공":["양초선행","중정기고"],
    "혼수모어":["사면초가","이간계","안영찰채"], "반객위주":["일고작기","사생취의","질풍노도","용맹무쌍"],
    "유좌유용":["휴양생식","제곤부위","안영찰채"], "선등함진":["만천과해","만전제발"],
    "강유겸제":["동장철벽","천시지리","진퇴유도","금창신"], "진퇴유도":["위위구조","동구적개","강유겸제","이퇴위진"],
    "견진연봉":["동장철벽","순수견양"], "위위구조":["간담상조","태청단경","현호제세"],
    "용왕직전":["천리추격","암전난방"], "만부막적":["용왕직전","천리추격"],
    "안영찰채":["간담상조","위위구조","미우주무","전위위안","유좌유용"], "일고작기":["사생취의","용맹무쌍","반객위주","천리추격"],
    ...
    "휴양생식":["양초선행","현호제세"], "사면초가":["기문둔갑","화소적벽"],
    "심모원려":["사면초가","기문둔갑"], "횡소천군":["강유겸제","용맹무쌍"],
    "천리추격":["극적제승","암전난방","체천행도","일고작기"], "암전난방":["극적제승","질풍노도"],
    "사소도":["이간계","낙정하석"], "미우주무":["현호제세","태청단경"],
    "이아환아":["금철교명","동장철벽"], "제곤부위":["태청단경","현호제세"],
    "금낭묘계":["만천과해","태청단경"], "체천행도":["반객위주","질풍노도","천리추격"],
    "금창신":["동구적개","강유겸제","간담상조"], "승승장구":["질풍노도","암전난방","용맹무쌍"]
};
