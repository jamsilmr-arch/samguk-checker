...
// [스크린샷 오류 교정] 메인 딜러 피해 감소 완전 철거 및 극딜/흡혈 종결 프리셋
const EQ_PRESETS = {
    PHYS_CARRY: ["호분관","피해 가함","창병 피해 가함","명광갑","무용 피해 가함","창병 배반, 공심 상승","치룡패","무용 피해 가함","창병 배반, 공심 상승"],
    PHYS_COMBO: ["백옥잠","연격률","창병 피해 가함","세린갑","무용 피해 가함","창병 배반, 공심 상승","쌍호뉴","연격률","창병 배반, 공심 상승"],
    STR_CARRY:  ["진현관","모략 피해 가함","창병 피해 가함","명재복","모략 피해 가함","창병 배반, 공심 상승","박산로","배반, 공심 상승","창병 배반, 공심 상승"],
...
const internalMasterEquipmentMap = {
    ...
    "관우": { helmet: { name: "호분관", attr1: "피해 가함", attr2: "창병 피해 가함" }, armor: { name: "명광갑", attr1: "무용 피해 가함", attr2: "창병 배반, 공심 상승" }, accessory: { name: "치룡패", attr1: "무용 피해 가함", attr2: "창병 배반, 공심 상승" } },
