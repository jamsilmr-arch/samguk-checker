...
// [규격 오류 100% 교정] 어품 2단계 규칙 준수 프리셋 (갑옷/장신구 2차는 무조건 피해 감소 또는 배반, 공심 상승)
const EQ_PRESETS = {
...
// [불법 스탯 전면 철거] 전 장수의 갑옷/장신구 2차 슬롯을 병종 피해 감소 및 배반, 공심 상승으로 정규화
const internalMasterEquipmentMap = {
    ...
    "조조(제왕)": { helmet: { name: "연함규", attr1: "피해 감소", attr2: "방패병 치유 효과 상승" }, armor: { name: "청등갑", attr1: "피해 감소", attr2: "방패병 피해 감소" }, accessory: { name: "사남패", attr1: "피해 감소", attr2: "방패병 피해 감소" } },
    ...
    "장비": { helmet: { name: "연함규", attr1: "피해 감소", attr2: "창병 피해 가함" }, armor: { name: "청등갑", attr1: "피해 감소", attr2: "창병 피해 감소" }, accessory: { name: "사남패", attr1: "피해 감소", attr2: "창병 배반, 공심 상승" } }
};
