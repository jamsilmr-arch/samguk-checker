// [핵심 로직: 주석 및 불필요한 공백 최소화, 전역 데이터 구조 유지]
const internalMasterOfficerUniqueTacticMap = {"가후":"경달권변","곽가":"산무유책","사마의":"응시낭고","순욱":"거중지중","악진":"분용당선","전위":"축호과간","정욱":"십면매복","조조(제왕)":"군령여산","조조":"효웅","장료":"함진살적","장합":"교변병기","하후돈":"발시담정","하후연":"충용","관우":"무성","강유":"담대여두","마대":"습참","마초":"출수법","서서":"절절학문","사마가":"만왕","위연":"실병제위","유비":"인정","유비(제왕)":"재주복주","장비":"연인노호","제갈량":"초선차전","조운":"칠진칠출","황충":"적혈도","황월영":"묘산천기","대교":"정수유심","노숙":"탑상책","소교":"화용욕모","손견":"강동맹호","손권":"웅거","손상향":"효희","손책":"강동패주","손권(제왕)":"겸권상계","여몽":"백의도강","육손":"지변규려","육항":"청백충근","주유":"봉화연천","주태":"청라산개","정보":"칠척사모","황개":"요원지화","채문희":"비분시","장녕":"천의난위","동탁":"전권난정","여포":"천하무쌍","초선":"폐월","장각":"황천당립","화타":"청낭제세","장보":"요풍사기","좌자":"화겁생기","우길":"태평경","안량":"효장","원소":"사소도","공손찬":"고유 전법 누락"};
...
const analyzedMetaArchetypes = [
    {id:"wei_sima_shield", name:"위나라 응시낭고 방패 덱 (추형진)", concept:"사마의의 장기전 종결 덱", formation:"추형진", officers:[{name:"사마의",chosenTactics:["응시낭고","심모원려","사면초가"]},{name:"조조",chosenTactics:["효웅","휴양생식","현호제세"]},{name:"가후",chosenTactics:["경달권변","혼수모어","이간계"]}]},
    {id:"wei_flawless_assassin", name:"위나라 무결점 암살 덱 (호도진)", concept:"장료의 확정 암살 진화형 덱", formation:"호도진", officers:[{name:"장료",chosenTactics:["함진살적","질풍노도","반객위주"]},{name:"조조",chosenTactics:["군령여산","횡징폭렴","진퇴유도"]},{name:"곽가",chosenTactics:["산무유책","동구적개","강유겸제"]}]},
    {id:"wei_assassin", name:"위나라 신속 암살 덱 (호도진)", concept:"장료 적 주장 정밀 저격 랭커 덱", formation:"호도진", officers:[{name:"장료",chosenTactics:["함진살적","질풍노도","반객위주"]},{name:"조조",chosenTactics:["군령여산","혼수모어","진퇴유도"]},{name:"악진",chosenTactics:["분용당선","동구적개","강유겸제"]}]},
    {id:"shu_combo_spear", name:"촉나라 연격 창병 덱 (구행진)", concept:"마초의 확산 폭딜 랭커 조합", formation:"구행진", officers:[{name:"위연",chosenTactics:["실병제위","진퇴유도","이퇴위진"]},{name:"마초",chosenTactics:["출수법","용맹무쌍","반객위주"]},{name:"서서",chosenTactics:["절절학문","문치무공","혼수모어"]}]},
    {id:"shu_evasion_bangwon", name:"촉나라 황제강 디버프 덱 (방원진)", concept:"강유의 스탯 무한 강탈 조합", formation:"방원진", officers:[{name:"황충",chosenTactics:["적혈도","강유겸제","진퇴유도"]},{name:"제갈량",chosenTactics:["초선차전","전위위안","안영찰채"]},{name:"강유",chosenTactics:["담대여두","반객위주","일고작기"]}]},
    {id:"qun_cavalry", name:"군웅 돌격 기병 덱 (구행진)", concept:"여포 추격(돌격) 분쇄 랭커 조합", formation:"구행진", officers:[{name:"원소",chosenTactics:["사소도","견진연봉","위위구조"]},{name:"여포",chosenTactics:["천하무쌍","용왕직전","만부막적"]},{name:"동탁",chosenTactics:["전권난정","운주유악","횡징폭렴"]}]},
    {id:"wu_magic_bow", name:"오나라 모략 신기루 덱 (구행진)", concept:"손권의 복합 피해 캐리 조합", formation:"구행진", officers:[{name:"손권",chosenTactics:["웅거","진퇴유도","강유겸제"]},{name:"육항",chosenTactics:["청백충근","수상개화","요사여신"]},{name:"노숙",chosenTactics:["탑상책","분성지계","여자동포"]}]}
];
...
const internalBondRules = [
    ...
    {name:"가모정세", req:2, heroes:["조조","조조(제왕)","곽가"], effect:"모략 피해 4% 증가, 무용 피해 4% 감소"}, {name:"위실주석", req:2, heroes:["하후돈","하후연"], effect:"파갑 8% 증가"},
...
const metaHawkRecommendationMap = {"wei_sima_shield":{name:"호생",skill:"장기전 생존 200% 보장"},"wei_flawless_assassin":{name:"전광",skill:"무용/통솔 증가 및 선공"},"wei_assassin":{name:"삭풍",skill:"마무리 160% 물리딜"},"wu_magic_bow":{name:"능소",skill:"시작 시 피해 30% 감소"},"shu_combo_spear":{name:"열공",skill:"무용/통솔 증가 펌핑"},"shu_evasion_bangwon":{name:"결운",skill:"생존력 극대화"},"qun_cavalry":{name:"열공",skill:"무용/통솔 30% 증가 돌파"}};
...
const metaHawkRandomAttributesMap = {"wei_sima_shield":{attr1:{rank1:"통솔 +12%",rank2:"모략 +10%"},attr2:{rank1:"피감 +10%",rank2:"치유 +10%"},attr3:{rank1:"디버프 해제",rank2:"피격시 저항"}}, "wei_flawless_assassin":{attr1:{rank1:"속도 +25",rank2:"무용 +12%"},attr2:{rank1:"파갑 +12%",rank2:"피증 +8%"},attr3:{rank1:"선공",rank2:"제어면역"}}, "custom":{attr1:{rank1:"전능 +5%",rank2:"통솔 +10%"},attr2:{rank1:"피증 +6%",rank2:"피감 +6%"},attr3:{rank1:"제어면역",rank2:"선공"}}};
const systemGuideInsights = {"wei_sima_shield":"💡 [장기전 종결 메타] 조조 방어막+가후 혼란+사마의 폭딜 정통 0티어.","wei_flawless_assassin":"💡 [진화형 종결 메타] 장료 2턴 통찰(제어면역) 암살 최적화.","wei_assassin":"💡 [랭커 메타] 장료 반객위주 스택 정밀 저격.","wu_magic_bow":"💡 [랭커 메타] 손권 복합 딜링 대기만성형 조합.","shu_combo_spear":"💡 [랭커 메타] 마초 반객위주 물리 스택 확산딜.","shu_evasion_bangwon":"💡 [랭커 메타] 강유 적 스탯 무한 강탈 방원진 조합.","qun_cavalry":"💡 [랭커 메타] 여포 추격(돌격) 전법 1턴킬 조합."};
...
// [핵심 로직: 메타 덱 추적 연산 모듈화 - 코드 40여줄 경량화]
...
function generateStructuredFeedback(deck, heroDataMap, tacticDataMap) {
    ...
    if (!match || match.maxScore === 0) {
        if(curNames.length) fb.logs.push({ type: 'info', text: `💡 <strong>[커스텀 덱]</strong> 0티어 장수를 기반으로 덱을 재설계해 보십시오.` });
        ...
        if (metaIdx !== -1) {
            ...
            (off.chosenTactics || []).forEach((t, i) => {
                ...
                if (!cT && unmatchTac.length) {
                    const pTac = unmatchTac.shift(), alts = tacticAlternativesMap[pTac] || ["A급 전법", "B급 전법"];
                    fb.logs.push({ type: 'warning', text: `[${hName}] ${i+2}슬롯: 1순위 [${pTac}] / 2순위 [${alts[0]}] 권장` });
                } else if (cT) {
...
// [이전 지시사항 보존: 1군~5군 네이밍 강제 동기화 로직 포함]
    ...
    try {
        ...
        dynamicPresetDecks.sort((a,b) => (a.originIdx||0) - (b.originIdx||0)).forEach((deck, aIdx) => {
            ...
            if (curNames.length > 0) {
                ...
                const hA = metaHawkRandomAttributesMap[match?.bestMeta?.id || "custom"];
