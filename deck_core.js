// [시스템 분석] deck_core.js - 장비 동적 할당 알고리즘 및 UI 렌더링 버그 픽스
...
// [로직 수정] 장비 반환 함수: 역할군(tactical, support, physical)에 따라 고유 명칭과 속성을 완벽히 분리 할당
function getOfficerEquipment(officerName, deckUnitType = "방패병") {
    ...
    if (isTac) {
        return { 
            ...
            accessory: { name: "박산로", attr1: "모략 피해 가함", attr2: `${deckUnitType} 피해 감소` } 
        };
    } else if (isSup) {
        return { 
            helmet: { name: "오기건", attr1: "피해 감소", attr2: "통솔 증가" }, 
            armor: { name: "팔괘의", attr1: "피해 감소", attr2: "치유 효과 상승" }, 
            accessory: { name: "청랑서", attr1: "치유 효과 상승", attr2: `${deckUnitType} 피해 감소` } 
        };
    } else {
        // 물리(무용) 딜러군 기본값 처리
        return { 
            helmet: { name: "사자관", attr1: "피해 감소", attr2: "통솔 증가" }, 
            armor: { name: "오금갑", attr1: "피해 감소", attr2: "무용 피해 가함" }, 
            accessory: { name: "야명주", attr1: "무용 피해 가함", attr2: `${deckUnitType} 피해 감소` } 
        };
    }
}
