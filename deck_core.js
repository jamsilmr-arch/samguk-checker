// [시스템 분석] deck_core.js - 전서버 랭커 실전 1~9위 메타 덱 완전 반영 종결 엔진
console.log("[시스템 분석] deck_core.js 전서버 랭커 실전 1~9위 메타 덱 완전 반영 종결 엔진 기동");
...
const tacticAlternativesMap = {
    ...
    "횡징폭렴":["간담상조","동구적개","동장철벽","홍수첨향"],
    "동장철벽":["간담상조","견불가최","천시지리","동구적개"],
    "전위위안":["간담상조","태청단경","현호제세","제곤부위","안영찰채"],
    "이퇴위진":["미우주무","천시지리","진퇴유도","홍수첨향"],
    ...
    "진퇴유도":["위위구조","동구적개","강유겸제","이퇴위진"],
    "견진연봉":["동장철벽","순수견양"],
    "위위구조":["간담상조","태청단경","현호제세"],
    "용왕직전":["천리추격","암전난방"],
    "만부막적":["용왕직전","천리추격"],
    "안영찰채":["간담상조","위위구조","미우주무","전위위안","유좌유용"],
    "일고작기":["사생취의","용맹무쌍","반객위주","천리추격"],
    "여자동포":["동구적개","천시지리"],
...
// [고도화] 전서버 랭커 실전 1~9위 메타 덱 완전 반영 리스트
...
const metaDeckUnitTypeMap = {
    ...
    "qun_jwaja_jangnyeong_ugil":"궁병",
    "wu_sogyo_nosuk_yukson":"방패병",
    "shu_sp_yubi_jangbi_gangyu":"방패병",
    "shu_gwanu_hwangchung_yubi":"기병",
    "wu_songwon_yukhang_nosuk":"궁병",
    "qun_wonso_dongtak_yeopo":"기병"
};
