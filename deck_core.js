// [시스템 분석] deck_core.js - 초경량 크로스 브릿지 엔진 (가후 투구 백옥잠 0티어 교체 및 병종 자동 판별 픽스 완료)
...
// 🚨 가후 전용 투구를 '진현관'에서 '백옥잠(모략/속도 하이브리드)'으로 완벽하게 교체
const rawEqOverrides = [
    ...
    ["가후", "백옥잠|피해 감소|방패병 치유 효과 상승|신속", "명재복|피해 감소|방패병 피해 감소|천안", "박산로|피해 감소|방패병 치유 효과 상승|영전"],
